...
public class ClientService {
    ...
    public void updateName(String dni, ClientNameUpdating clientNameUpdating) {
        Client client = this.clientPersistence.readByDni(dni);
        client.setName(clientNameUpdating.getName());
        this.clientPersistence.update(client);
